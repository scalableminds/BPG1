...
(function() {
  var $, MARGIN, NODE_SIZE, add_vectors, collides_with, color, distance_vector, drag, draw_nodes, get_collisions, list_of_nodes, move_if_collision, move_node, overlap_vector, reverse_vector, subtract_vectors, try_this;
  ...
  */
  ...
  move_if_collision = function(curr_node_position, origin) {
    ...
    loop_iterations = 0;
    while ((no_collisions === false) && (loop_iterations < 4)) {
